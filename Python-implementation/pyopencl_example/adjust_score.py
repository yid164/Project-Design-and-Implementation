...
if __name__ == '__main__':
    ...
    print('exectue kernel program')
    evt = prg.adjust_score(queue)
    ...
    print("upload data to device took   :{}".format(time_devicedata_load - time_ctx_queue_creation))
    print("compile kernel took          :{}".format(time_kernel_compilation - time_devicedata_load))
